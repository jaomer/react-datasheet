...
var DataCell = function (_PureComponent) {
  ...
  _createClass(DataCell, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!this.cellWidth) {
        this.cellWidth = this.cellRef && this.cellRef.current ? this.cellRef.current.offsetWidth : undefined;
      ...
      if (this.props.editing === true && prevProps.editing === false) {
        ...
        this.setState({ value: value, cellWidth: this.cellWidth, reverting: false });
      }
    ...
    value: function render() {
      var _props7 = this.props,
          row = _props7.row,
          col = _props7.col,
          borders = _props7.borders,
          isStart = _props7.isStart,
          cell = _props7.cell,
      ...
      var className = [cell.className, 'cell', cell.overflow, selected && 'selected', editing && 'editing', cell.readOnly && 'read-only', updated && 'updated', this.props.hideColumn && 'hide-cell'].filter(function (a) {
        return a;
      }).join(' ');
...
DataCell.propTypes = {
  ...
  hideColumn: _propTypes2.default.bool
};
