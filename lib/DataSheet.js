...
var DataSheet = function (_PureComponent) {
  ...
  _createClass(DataSheet, [{
    key: 'getCellBorders',
    value: function getCellBorders(i, j) {
      return [i === Math.min(this.state.start.i, this.state.end.i), j === Math.max(this.state.start.j, this.state.end.j), i === Math.max(this.state.start.i, this.state.end.i), j === Math.min(this.state.start.j, this.state.end.j)];
    }
  }, {
    ...
    value: function handleKey(e) {
      ...
      var f2KeyPressed = keyCode === _keys.F2_KEY;
    ...
    value: function render() {
      ...
      var _props6 = this.props,
          ...
          data = _props6.data,
          headerNames = _props6.headerNames,
          keyFn = _props6.keyFn,
          onRowAdd = _props6.onRowAdd,
          hideColumns = _props6.hideColumns;
            ...
            return _react2.default.createElement(
              ...
              row.map(function (cell, j) {
                ...
                return _react2.default.createElement(_DataCell2.default, _extends({
                  ...
                  row: i,
                  col: j,
                  borders: _this4.getCellBorders(i, j),
                  isStart: _this4.state.start.i === i && _this4.state.start.j === j,
                  cell: cell,
                  forceEdit: false,
...
DataSheet.propTypes = {
  ...
  onRowAdd: _propTypes2.default.func,
