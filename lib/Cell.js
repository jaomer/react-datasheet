...
var Cell = function (_PureComponent) {
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      var cellBorderClasses = this.props.borders.map(function (v, i) {
        if (v) {
          return 'cell-border-div-' + i;
        }
      }).filter(Boolean).join(" ");
      ...
      return _react2.default.createElement(
        'td',
        _extends({
          className: (0, _clsx2.default)(className, this.props.selected && !this.props.isStart && 'cell-selected-not-start'),
        ...
        this.props.selected && this.props.borders[1] && this.props.borders[2] && _react2.default.createElement(
          'svg',
          { className: 'cell-selected-svg' },
          _react2.default.createElement('rect', { x: '1.5', y: '1.5', className: 'cell-selected-rect' }),
          this.props.editing && _react2.default.createElement('rect', { x: '1.5', y: '1.5', className: 'cell-editing-rect' })
        ),
        this.props.children,
        this.props.selected && _react2.default.createElement('div', { className: 'cell-border-div ' + cellBorderClasses })
      );
    }
  }]);
...
Cell.propTypes = {
  ...
  borders: _propTypes2.default.array,
  isStart: _propTypes2.default.bool,
